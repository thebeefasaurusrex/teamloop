...
for(const name of ['SKILL.md','references','scripts']) await fs.cp(path.join(skill,name),path.join(destination,name),{recursive:true,errorOnExist:true,force:false});
